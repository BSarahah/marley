...
frappe.ui.form.BeneficiaryQuickEntryForm = class BeneficiaryQuickEntryForm extends frappe.ui.form.QuickEntryForm {
	...
	render_dialog() {
		...
		// preserve standard_fields order, splice custom fields after Beneficiary name fields
	...
	get_standard_fields() {
		return [
			...
			},
			{
				...
				fieldtype: 'Select',
				options: frappe.meta.get_docfield('Beneficiary', 'blood_group').options
			},
			{
