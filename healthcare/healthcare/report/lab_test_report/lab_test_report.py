		...
		row = frappe._dict(
			{
				...
				"beneficiary": lab_test.beneficiary,
				"beneficiary_name": lab_test.beneficiary_name,
...
def get_columns():
	return [
		...
		{"fieldname": "beneficiary_name", "label": _("Beneficiary Name"), "fieldtype": "Data", "width": "120"},
		{
			"fieldname": "employee",
