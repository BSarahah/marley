...
class Analytics(object):
	def __init__(self, filters=None):
		"""Beneficiary Appointment Analytics Report."""
	...
	def get_appointments_based_on_healthcare_practitioner(self):
		...
		self.entries = frappe.db.get_all(
			...
			fields=["appointment_date", "name", "beneficiary", "practitioner"],
			filters=filters,
		)
	...
	def get_appointments_based_on_medical_department(self):
		...
		self.entries = frappe.db.get_all(
			"Beneficiary Appointment",
			fields=["appointment_date", "name", "beneficiary", "practitioner", "department"],
			filters=filters,
		)
