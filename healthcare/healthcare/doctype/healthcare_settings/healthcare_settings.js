...
frappe.tour['Healthcare Settings'] = [
	{
		fieldname: 'link_customer_to_beneficiary',
		title: __('Link Customer to Beneficiary'),
		description: __('If checked, a customer will be created for every Beneficiary. Beneficiary Invoices will be created against this Customer. You can also select existing Customer while creating a Beneficiary. This field is checked by default.')
	},
	{
	...
	},
	{
		...
		description: __('If your Healthcare facility bills registrations of Beneficiarys, you can check this and set the Registration Fee in the field below. Checking this will create new Beneficiarys with a Disabled status by default and will only be enabled after invoicing the Registration Fee.')
	},
	{
	...
	},
	{
		...
		description: __('Validates all mandatory tasks in nursing checklist to be Completed before a Beneficiary transactional event. For example, if any of the tasks as part of the Discharge Checklist is not in status Completed, system will alert the user while trying to Discharge the Beneficiary from inbeneficiary facility')
	},
	{
		fieldname: 'inbeneficiary_visit_charge_item',
		title: __('Healthcare Service Items'),
		description: __('You can create a service item for Inbeneficiary Visit Charge and set it here. Similarly, you can set up other Healthcare Service Items for billing in this section. Click ') + "<a href='https://frappehealth.com/docs/v13/user/manual/en/healthcare/healthcare_settings#2-default-healthcare-service-items' target='_blank'>here</a>" + __(' to know more')
	},
	{
	...
	},
	{
		...
		title: __('Out Beneficiary SMS alerts'),
		description: __('If you want to send SMS alert on Beneficiary Registration, you can enable this option. Similary, you can set up Out Beneficiary SMS alerts for other functionalities in this section. Click ') + "<a href='https://frappehealth.com/docs/v13/user/manual/en/healthcare/healthcare_settings#4-out-beneficiary-sms-alerts' target='_blank'>here</a>" + __(' to know more')
	}
];
